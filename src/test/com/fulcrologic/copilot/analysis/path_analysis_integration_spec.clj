(ns com.fulcrologic.copilot.analysis.path-analysis-integration-spec
...
(specification "Path-based analysis integration tests" :integration
  ...
  (let [test-file (io/resource "com/fulcrologic/copilot/test_data/path_analysis_problems.clj")
