(ns com.fulcrologic.guardrails-analyzer.daemon.server.bindings-spec
  (:require
    [com.fulcrologic.guardrails-analyzer.analysis.analyze-test-utils :as cp.atu]
    [com.fulcrologic.guardrails-analyzer.artifacts :as cp.art]
    [com.fulcrologic.guardrails-analyzer.daemon.server.bindings :refer [encode-for]]
    [com.fulcrologic.guardrails-analyzer.test-checkers :as tc]
    [com.fulcrologic.guardrails-analyzer.test-fixtures :as tf]
    [fulcro-spec.check :as _]
    [fulcro-spec.core :refer [=check=> assertions component specification]]))
