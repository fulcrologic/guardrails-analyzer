(ns com.fulcrologic.guardrails-analyzer.test-cases-runner
  (:require
   [clojure.java.io :as io]
   [clojure.set :as set]
   [clojure.string :as str]
   [clojure.test :as t]
   [com.fulcrologic.guardrails-analyzer.analysis.analyzer :refer [defanalyzer]]
        ...
        (cp.checker/check! tc-info
                           (fn [env]
                             (run-test-cases! {:tc-file tc-file :report! t/do-report}
                                              (assoc tc-info
                                                     :problems (cp.art/get-problems env)
...
(defanalyzer com.fulcrologic.guardrails-analyzer.test-cases-runner/deftc [env sexpr] {})
