(ns com.fulcrologic.guardrails-analyzer.system-test
  (:require
    [clojure.test :as t]
    [com.fulcrologic.guardrails-analyzer.test-cases-runner :as tcr]
...
(defmutation run-test-case [_]
  (action [{:keys [state]}]
    (let [tc-file "src/system_test/com/fulcrologic/guardrails-analyzer/smoke_test.clj"]
