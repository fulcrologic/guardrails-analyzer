...
(ns com.fulcrologic.guardrails-analyzer.analysis.function-type
  (:require
...
(>defn analyze-function-call! [env function argtypes]
       ...
       (cond
         ...
         :else
         (let [env           (cp.spec/with-spec-system env (cp.art/fn-spec-system function))
               {::cp.art/keys [arities] ::keys [partial-argtypes]} function
