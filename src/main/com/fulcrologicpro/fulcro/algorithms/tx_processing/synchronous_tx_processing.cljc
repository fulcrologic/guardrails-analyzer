(ns com.fulcrologicpro.fulcro.algorithms.tx-processing.synchronous-tx-processing
   ...
   * `ptransact!`: Pessimistic transactions are a legacy feature of Fulcro 2 that is no longer necessary. New
   ...
   "
  #?(:cljs (:require-macros [com.fulcrologicpro.fulcro.algorithms.tx-processing.synchronous-tx-processing :refer [in-transaction]]))
  (:require
    [clojure.set :as set]
    ...
    [com.fulcrologicpro.fulcro.inspect.inspect-client :refer [ido ilet]]
    com.fulcrologicpro.fulcro.specs
...
#?(:clj
   (defmacro in-transaction [app-sym & body]
     `(let [id# (:com.fulcrologicpro.fulcro.application/id ~app-sym)]
...
(defn top-level?
  ...
  [{:com.fulcrologicpro.fulcro.application/keys [id]}]
...
(defn in-transaction?
  ...
  [{:com.fulcrologicpro.fulcro.application/keys [id] :as app}]
...
(defn submit-sync-tx!
  ...
  ([{:com.fulcrologicpro.fulcro.application/keys [runtime-atom] :as app} tx options]
...
(defn with-synchronous-transactions
  ...
  "
  [app]
  (let [remotes     (-> app :com.fulcrologicpro.fulcro.application/runtime-atom deref
                      :com.fulcrologicpro.fulcro.application/remotes keys)
        send-queues (zipmap remotes (repeatedly #(atom [])))]
    (-> app
      (update :com.fulcrologicpro.fulcro.application/algorithms assoc
        :com.fulcrologicpro.fulcro.algorithm/tx! submit-sync-tx!
        :com.fulcrologicpro.fulcro.algorithm/abort! abort!)
