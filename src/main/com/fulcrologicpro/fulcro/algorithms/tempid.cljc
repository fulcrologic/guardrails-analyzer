(ns com.fulcrologicpro.fulcro.algorithms.tempid
...
(defn resolve-tempids!
  ...
  [{:com.fulcrologicpro.fulcro.application/keys [state-atom runtime-atom]} tx-result]
  (let [tid->rid (result->tempid->realid tx-result)]
    (swap! state-atom resolve-tempids tid->rid)
    (swap! runtime-atom
      (fn [r]
        (-> r
          (update :com.fulcrologicpro.fulcro.transactions/submission-queue resolve-tempids tid->rid)
          (update :com.fulcrologicpro.fulcro.transactions/active-queue resolve-tempids tid->rid)
          (update :com.fulcrologicpro.fulcro.transactions/send-queues resolve-tempids tid->rid))))))
