(ns com.fulcrologicpro.fulcro.rendering.ident-optimized-render
...
(defn render-component!
  ...
  #?(:cljs
     (if (and c ident)
       (let [{:com.fulcrologicpro.fulcro.application/keys [state-atom]} app
       ...
       (let [root (-> app :com.fulcrologicpro.fulcro.application/runtime-atom deref :com.fulcrologicpro.fulcro.application/app-root)]
         (when (not= c root)
...
(defn render-dependents-of-ident!
  ...
  (let [{:com.fulcrologicpro.fulcro.application/keys [runtime-atom]} app
        {:com.fulcrologicpro.fulcro.application/keys [indexes]} @runtime-atom
...
(defn render-stale-components!
  ...
  [app]
  (let [{:com.fulcrologicpro.fulcro.application/keys [runtime-atom state-atom]} app
        {:com.fulcrologicpro.fulcro.application/keys [indexes last-rendered-state
