(ns com.fulcrologicpro.fulcro.dom
  "Client-side DOM macros and functions. For isomorphic (server) support, see also com.fulcrologicpro.fulcro.dom-server"
  (:refer-clojure :exclude [map meta time mask select use set symbol filter])
  (:require-macros [com.fulcrologicpro.fulcro.dom])
  (:require
    ...
    [goog.object :as gobj]
    [goog.dom :as gdom]
    [com.fulcrologicpro.fulcro.dom.inputs :as inputs]
...
(com.fulcrologicpro.fulcro.dom/gen-client-dom-fns com.fulcrologicpro.fulcro.dom/macro-create-element com.fulcrologicpro.fulcro.dom/macro-create-unwrapped-element)
