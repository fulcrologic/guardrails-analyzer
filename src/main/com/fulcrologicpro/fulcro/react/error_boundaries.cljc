(ns com.fulcrologicpro.fulcro.react.error-boundaries
  ...
  #?(:cljs (:require-macros com.fulcrologicpro.fulcro.react.error-boundaries))
  (:require
...
#?(:clj
   (defmacro error-boundary
     ...
     (ns ...
       (:require
         [com.fulcrologicpro.fulcro.react.error-boundaries :as eb]))
