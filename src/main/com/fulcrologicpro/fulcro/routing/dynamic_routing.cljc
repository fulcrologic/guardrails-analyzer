(ns com.fulcrologicpro.fulcro.routing.dynamic-routing
  ...
  #?(:cljs (:require-macros [com.fulcrologicpro.fulcro.routing.dynamic-routing]))
  (:require
    #?(:cljs [goog.object :as gobj])
    [clojure.zip :as zip]
    [com.fulcrologic.guardrails.core :refer [>fdef => ?]]
    [com.fulcrologicpro.fulcro.ui-state-machines :as uism :refer [defstatemachine]]
