(ns com.fulcrologicpro.fulcro.networking.tenacious-remote
  "A wrapper for remotes that adds automatic retry with exponential back-off behavior. This makes the remote more
   ...
   See `com.fulcrologicpro.fulcro.offline` for features that help support true offline modes of operation."
  (:require
