(ns com.fulcrologicpro.fulcro.application
  (:require
    [com.fulcrologicpro.fulcro.algorithms.lookup :as ah]
    [com.fulcrologicpro.fulcro.data-fetch :as df]
    [com.fulcrologicpro.fulcro.algorithms.denormalize :as fdn]
    [com.fulcrologicpro.fulcro.algorithms.indexing :as indexing]
    [com.fulcrologicpro.fulcro.algorithms.merge :as merge]
    [com.fulcrologicpro.fulcro.algorithms.do-not-use :as util]
    [com.fulcrologicpro.fulcro.algorithms.tempid :as tempid]
    [com.fulcrologicpro.fulcro.algorithms.normalize :as fnorm]
    [com.fulcrologicpro.fulcro.algorithms.scheduling :as sched]
    [com.fulcrologicpro.fulcro.algorithms.tx-processing :as txn]
    [com.fulcrologicpro.fulcro.algorithms.tx-processing.synchronous-tx-processing :as stx]
    [com.fulcrologicpro.fulcro.components :as comp]
    [com.fulcrologicpro.fulcro.mutations :as mut]
    [com.fulcrologicpro.fulcro.rendering.multiple-roots-renderer :as mrr]
     ...
     (when root-class
       (let [optimized-render!   (ah/app-algorithm app :optimized-render!)
         ...
         (swap! runtime-atom assoc
           ...
           :com.fulcrologicpro.fulcro.application/only-refresh #{}
           :com.fulcrologicpro.fulcro.application/to-refresh #{})))
...
(defn default-global-eql-transform
  ...
  - Any prop or join that is namespaced to com.fulcrologicpro.fulcro*
  - Any ident (as a prop or join) whose table name is namespaced ui or com.fulcrologicpro.fulcro*
                              ...
                              (let [ns       (some-> k kw-namespace)
                                ...
                                (or
                                  (and
                                    ...
                                    (or
                                      (= "ui" ns)
                                      (str/starts-with? ns "com.fulcrologicpro.fulcro.")))
                                  (and
                                    (string? ident-ns)
                                    (or
                                      (= "ui" ident-ns)
                                      (str/starts-with? ident-ns "com.fulcrologicpro.fulcro.")))))))))
...
(defn fulcro-app
   ...
   * `default-result-action!` - A `(fn [env])` that will be used in your mutations defined with `defmutation` as the
     ...
     default is value for this option is `com.fulcrologicpro.fulcro.mutations/default-result-action!`, which could be used
  ...
  ([{:keys [props-middleware
   ...
   (let [tx! (or submit-transaction! txn/default-tx!)]
     {::id           (tempid/uuid)
      ...
      ::algorithms   {:com.fulcrologicpro.fulcro.algorithm/tx!                    tx!
                      :com.fulcrologicpro.fulcro.algorithm/abort!                 (or abort-transaction! txn/abort!)
                      :com.fulcrologicpro.fulcro.algorithm/optimized-render!      (or optimized-render! mrr/render!)
                      :com.fulcrologicpro.fulcro.algorithm/initialize-state!      initialize-state!
                      :com.fulcrologicpro.fulcro.algorithm/shared-fn              shared-fn
                      :com.fulcrologicpro.fulcro.algorithm/render-root!           render-root!
                      :com.fulcrologicpro.fulcro.algorithm/hydrate-root!          hydrate-root!
                      :com.fulcrologicpro.fulcro.algorithm/unmount-root!          unmount-root!
                      :com.fulcrologicpro.fulcro.algorithm/render!                render!
                      :com.fulcrologicpro.fulcro.algorithm/remote-error?          (or remote-error? default-remote-error?)
                      :com.fulcrologicpro.fulcro.algorithm/global-error-action    global-error-action
                      :com.fulcrologicpro.fulcro.algorithm/merge*                 merge/merge*
                      :com.fulcrologicpro.fulcro.algorithm/default-result-action! (or default-result-action! mut/default-result-action!)
                      :com.fulcrologicpro.fulcro.algorithm/global-eql-transform   (or global-eql-transform default-global-eql-transform)
                      :com.fulcrologicpro.fulcro.algorithm/index-root!            indexing/index-root!
                      :com.fulcrologicpro.fulcro.algorithm/index-component!       indexing/index-component!
                      :com.fulcrologicpro.fulcro.algorithm/drop-component!        indexing/drop-component!
                      :com.fulcrologicpro.fulcro.algorithm/props-middleware       props-middleware
                      :com.fulcrologicpro.fulcro.algorithm/render-middleware      render-middleware
                      :com.fulcrologicpro.fulcro.algorithm/schedule-render!       schedule-render!}
      ::runtime-atom (atom
                       {::app-root                        nil
                        ::mount-node                      nil
