(ns com.fulcrologicpro.edn-query-language.core
...
(when INCLUDE_SPECS
  ...
  (s/def :com.fulcrologicpro.edn-query-language.ast/query ::join-query)
  (s/def :com.fulcrologicpro.edn-query-language.ast/key (s/or :prop ::property :ident ::ident :sym symbol?))
  (s/def :com.fulcrologicpro.edn-query-language.ast/dispatch-key (s/or :prop ::property :sym symbol?))
  (s/def :com.fulcrologicpro.edn-query-language.ast/union-key ::property)

  (s/def :com.fulcrologicpro.edn-query-language.ast/children
    (s/coll-of :com.fulcrologicpro.edn-query-language.ast/node))

  (s/def :com.fulcrologicpro.edn-query-language.ast/root
    (s/and (s/keys :req-un [:com.fulcrologicpro.edn-query-language.ast/type :com.fulcrologicpro.edn-query-language.ast/children])
      #(= :root (:type %))
  ...
  (defmethod node-type nil [_]
    (s/keys :req-un [:com.fulcrologicpro.edn-query-language.ast/key :com.fulcrologicpro.edn-query-language.ast/dispatch-key]))

  (defmethod node-type :prop [_]
    (s/keys :req-un [:com.fulcrologicpro.edn-query-language.ast/type :com.fulcrologicpro.edn-query-language.ast/key :com.fulcrologicpro.edn-query-language.ast/dispatch-key]))

  (defmethod node-type :join [_]
    (s/and (s/keys :req-un [:com.fulcrologicpro.edn-query-language.ast/type :com.fulcrologicpro.edn-query-language.ast/key :com.fulcrologicpro.edn-query-language.ast/dispatch-key :com.fulcrologicpro.edn-query-language.ast/query] :opt-un [:com.fulcrologicpro.edn-query-language.ast/children])
  ...
  (defmethod node-type :union [_]
    (s/and (s/keys :req-un [:com.fulcrologicpro.edn-query-language.ast/type :com.fulcrologicpro.edn-query-language.ast/query :com.fulcrologicpro.edn-query-language.ast/children])
      #(every? (comp #{:union-entry} :type) (:children %))))

  (defmethod node-type :union-entry [_]
    (s/and (s/keys :req-un [:com.fulcrologicpro.edn-query-language.ast/type :com.fulcrologicpro.edn-query-language.ast/union-key :com.fulcrologicpro.edn-query-language.ast/query :com.fulcrologicpro.edn-query-language.ast/children])
      (fn [x] (every? (comp #(contains? #{:prop :join :call nil} %) :type) (:children x)))))

  (defmethod node-type :call [_]
    (s/and (s/keys
             :req-un [:com.fulcrologicpro.edn-query-language.ast/type :com.fulcrologicpro.edn-query-language.ast/key :com.fulcrologicpro.edn-query-language.ast/dispatch-key ::params]
             :opt-un [:com.fulcrologicpro.edn-query-language.ast/query :com.fulcrologicpro.edn-query-language.ast/children])
      (fn [x] (every? (comp #(contains? #{:prop :join :call nil} %) :type) (:children x)))))

  (defmethod node-type :root [_]
    (s/spec :com.fulcrologicpro.edn-query-language.ast/root))

  (s/def :com.fulcrologicpro.edn-query-language.ast/type (set (keys (methods node-type))))
  (s/def :com.fulcrologicpro.edn-query-language.ast/node (s/multi-spec node-type :type)))
...
(when INCLUDE_SPECS
  (s/fdef query->ast
    ...
    :ret :com.fulcrologicpro.edn-query-language.ast/root)

  (s/fdef query->ast1
    :args (s/cat :query ::query)
    :ret (s/nilable :com.fulcrologicpro.edn-query-language.ast/node))

  (s/fdef ast->query
    :args (s/cat :ast :com.fulcrologicpro.edn-query-language.ast/node)
    :ret ::query)
  ...
  (s/fdef transduce-children
    :args (s/cat :xform fn? :node :com.fulcrologicpro.edn-query-language.ast/node)
    :ret :com.fulcrologicpro.edn-query-language.ast/node)
  ...
  (s/fdef merge-asts
    :args (s/cat :qa :com.fulcrologicpro.edn-query-language.ast/node, :qb :com.fulcrologicpro.edn-query-language.ast/node)
    :ret (s/nilable :com.fulcrologicpro.edn-query-language.ast/node))
