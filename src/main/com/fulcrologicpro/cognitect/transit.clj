...
(ns com.fulcrologicpro.cognitect.transit
  "An implementation of the transit-format for Clojure built
   on top of the transit-java library."
  (:refer-clojure :exclude [read])
  (:require [clojure.string :as str])
  (:import [com.fulcrologicpro.com.cognitect.transit WriteHandler ReadHandler ArrayReadHandler MapReadHandler
            ArrayReader TransitFactory TransitFactory$Format MapReader]
           [com.fulcrologicpro.com.cognitect.transit.SPI ReaderSPI]
...
(def default-write-handlers
   ...
   transit-java library."
  {
   ...
   com.fulcrologicpro.cognitect.transit.WithMeta
   (reify WriteHandler
     (tag [_ _] "with-meta")
     (rep [_ o]
       (TransitFactory/taggedValue "array"
         [(.-value ^com.fulcrologicpro.cognitect.transit.WithMeta o)
          (.-meta ^com.fulcrologicpro.cognitect.transit.WithMeta o)]))
     (stringRep [_ _] nil)
     (getVerboseHandler [_] nil))})
...
(defn write
  ...
  [^Writer writer o]
  (.write ^com.fulcrologicpro.com.cognitect.transit.Writer (.w writer) o))
...
(defn read
  ...
  [^Reader reader]
  (.read ^com.fulcrologicpro.com.cognitect.transit.Reader (.r reader)))
...
(comment
  (require 'com.fulcrologicpro.cognitect.transit)
  (in-ns 'com.fulcrologicpro.cognitect.transit)
