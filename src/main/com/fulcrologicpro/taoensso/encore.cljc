(ns com.fulcrologicpro.taoensso.encore
...
(let [limit-spec (fn [n ms] (LimitSpec. n ms))]
...
(defmacro msecs "Compile-time version of `ms`" [& opts]
  (eval `(com.fulcrologicpro.taoensso.encore/ms ~@opts)))
...
#?(:clj
   (defmacro deprecated
     "Elides body when `com.fulcrologicpro.taoensso.elide-deprecated` JVM property or
     `TAOENSSO_ELIDE_DEPRECATED` environment variable is e/o #{\"true\" \"TRUE\"}."
     [& body]
     (if (get-sys-bool false
           "com.fulcrologicpro.taoensso.elide-deprecated"
...
(deprecated
  ...
  (defmacro if-lets [& args] `(com.fulcrologicpro.taoensso.encore/if-let ~@args))
  (defmacro when-lets [& args] `(com.fulcrologicpro.taoensso.encore/when-let ~@args))
  (defmacro if-not* [& args] `(com.fulcrologicpro.taoensso.encore/if-not ~@args))
  (defmacro cond* [& args] `(com.fulcrologicpro.taoensso.encore/cond ~@args))
  (defmacro defonce* [& args] `(com.fulcrologicpro.taoensso.encore/defonce ~@args))
  (defmacro cond-throw [& args] `(com.fulcrologicpro.taoensso.encore/cond! ~@args))
  (defmacro catch-errors* [& args] `(com.fulcrologicpro.taoensso.encore/catching ~@args))
  (defmacro use-fixtures* [& args] `(com.fulcrologicpro.taoensso.encore/use-fixtures ~@args))
  (defmacro nano-time* [& args] `(com.fulcrologicpro.taoensso.encore/now-nano* ~@args))
  (defmacro qbench [& args] `(com.fulcrologicpro.taoensso.encore/quick-bench ~@args))
