(ns com.fulcrologicpro.taoensso.timbre.appenders.core
  ...
  #?(:clj
     (:require
      ...
      [com.fulcrologicpro.taoensso.encore :as enc :refer [ qb deprecated]])
  ...
  #?(:cljs
     (:require-macros
      [com.fulcrologicpro.taoensso.encore :as enc-macros :refer [deprecated]])))

;; TODO Add a simple official rolling spit appender?

;;;; Println appender (clj & cljs)

#?(:clj (enc/declare-remote com.fulcrologicpro.taoensso.timbre/default-out
                            com.fulcrologicpro.taoensso.timbre/default-err))

#?(:clj (alias 'timbre 'com.fulcrologicpro.taoensso.timbre))
...
#?(:cljs
   (defn console-appender
     ...
     For accurate line numbers in Chrome, add these Blackbox[1] patterns:
       `/com.fulcrologicpro.taoensso/timbre/appenders/core\\.js$`
       `/com.fulcrologicpro.taoensso/timbre\\.js$`
       `/cljs/core\\.js$`
