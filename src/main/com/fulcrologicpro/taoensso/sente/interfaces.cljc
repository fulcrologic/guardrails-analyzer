(ns com.fulcrologicpro.taoensso.sente.interfaces
  "Alpha, subject to change.
  Public interfaces / extension points."
  (:require [com.fulcrologicpro.taoensso.encore :as enc]))

;;;; Server channels
;; To work with Sente, a web server needs to provide implementations for
;; the two protocols below. Please see the `com.fulcrologicpro.taoensso.sente.server-adapters.*`
