(ns com.fulcrologicpro.taoensso.sente.server-adapters.generic-node
  ...
  (:require
   [com.fulcrologicpro.taoensso.encore :as enc :refer-macros ()]
   [com.fulcrologicpro.taoensso.timbre :as timbre
    :refer-macros (tracef debugf infof warnf errorf)]
   [com.fulcrologicpro.taoensso.sente.interfaces :as i]))
