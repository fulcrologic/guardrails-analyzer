(ns com.fulcrologicpro.taoensso.sente.packers.transit
  "Alpha - subject to change!
  Optional Transit-format[1] IPacker implementation for use with Sente.
  [1] https://github.com/com.fulcrologicpro.cognitect/transit-format."
  ...
  #?(:clj
     (:require
      ...
      [com.fulcrologicpro.taoensso.timbre :as timbre]
      [com.fulcrologicpro.cognitect.transit :as transit]
      [com.fulcrologicpro.taoensso.sente.interfaces :as interfaces :refer (pack unpack)]))
...
(deftype TransitPacker [transit-fmt writer-opts reader-opts]
  com.fulcrologicpro.taoensso.sente.interfaces/IPacker
